...
main_application.geometry('720x640')
main_application.title("Bikash's Text Editor")
...
color_icon = (light_default_icon,dark_icon,monokai_icon,night_blue_icon,red_icon,light_plus_icon)

color_dict={
    'Light default' :('#000000','#ffffff'),
    'Dark':('#c4c4c4','#2d2d2d'),
    'Monokai':('#d3b774','#ffe8e8'),
...
font_box=ttk.Combobox(tool_bar,width=20,textvariable=font_families,state='readonly')
...
def change_font_size(main_application):
    ...
    text_editor.configure(font=(size_var,current_font_size))
...
edit.add_command(label="Clear all",image=clear_all_icon,compound=tk.LEFT,accelerator='ctrl+D',command=lambda:text_editor.delete(1.0,tk.END))

######find functionality##3
